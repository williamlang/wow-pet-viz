...
class AbilityTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'AbilityId', 'Name', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'abilityId', 'name', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(AbilityTableMap::COL_ID, AbilityTableMap::COL_ABILITY_ID, AbilityTableMap::COL_NAME, AbilityTableMap::COL_CREATED_AT, AbilityTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'ability_id', 'name', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'AbilityId' => 1, 'Name' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'abilityId' => 1, 'name' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        self::TYPE_COLNAME       => array(AbilityTableMap::COL_ID => 0, AbilityTableMap::COL_ABILITY_ID => 1, AbilityTableMap::COL_NAME => 2, AbilityTableMap::COL_CREATED_AT => 3, AbilityTableMap::COL_UPDATED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'ability_id' => 1, 'name' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
